...
insert into Colegiado (dniSol, nombreSol, apellidosSol, localidadSol, telefonoSol, titulacionSol, centroSol, anioSol, ibanSol, numeroColegiado, tipoSol, estadoSol, estadoCuota, estadoAsignacionPericial, fechaColegiacion) values
	...
	('1234312432J' ,'hernesto', 'alvarez alvarez', 'gallego', '549999789', 'ganadero', 'grupo entuhuerto', 1989, '6185993986753', '588948339', 'Pre-colegiado', 'Activo', 'Emitido', 'NA', '2019-12-29'),
	('4546574389B' ,'kazuya', 'mishima wins', 'japonés', '549566543', 'ingeniero', 'fundación topota', 1995, '5467892034987', '110299301', 'Pre-colegiado', 'Anulado', 'Pendiente', 'Asignado', '2021-8-23'),
	('9385783921W' ,'hermenegildo', 'gonzalez rose', 'canario', '546743453', 'bombero', 'unitoby', 1990, '6185993986753', '465326453', 'Pre-colegiado', 'Pendiente', 'Pagado', 'NA', '2022-3-2'),
	('2124678952G' ,'sol', 'bad guy', 'japonés', '654342645', 'camionero', 'gears sa', 1990, '3948579283019213', '449368980', 'Colegiado', 'Pendiente', 'Pagado', 'Asignado', '2021-2-8'),
	('2348597612B' ,'bruce', 'wayne batman', 'estadounidense', '634323654', 'superheroe', 'wayne enterprises', 1988, '7654674567456774', '567856705', 'Pre-colegiado', 'Activo', 'Emitido', 'NA', '2020-1-24'),
	('9876452397R' ,'geralt', 'de rivia', 'polaco', '967317211', 'policía', 'fundacion minabo', 1981, '2341236574982345', '764582345', 'Colegiado', 'Pendiente', 'Pagado', 'NA', '2021-3-3')
;
