...
public class SwingUtil {
	...
	/**
	 * Obtiene la posicion  de la fila seleccionada en la tabla de
	 * carreras o string vacio (si no existe)
	 */
	public static String getSelectedKey(JTable table, int pos) {
		int row = table.getSelectedRow(); // el item de primera columna es el id de carrera
		if (row >= 0)
			return (String) table.getModel().getValueAt(row, pos);
		else // no hay filas seleccionadas
			return "";
	}
	...
	/**
	 * Método showErrorDialog
	 * Muestra un JDialog con el aviso de un error
	 * 
	 * @param string, cadena
	 */
	public static void showErrorDialog(String string) {
		JOptionPane.showMessageDialog(null, string, 
				"Administración COIIPA - Aviso de error", JOptionPane.ERROR_MESSAGE);
	}
	
	/**
	 * Método showInformationDialog
	 * Muestra un JDialog con el aviso de información
	 * 
	 * @param string, cadena
	 */
	public static void showInformationDialog(String string) {
		JOptionPane.showMessageDialog(null, string, 
				"Administración COIIPA - Información importante", JOptionPane.INFORMATION_MESSAGE);
	}
}
